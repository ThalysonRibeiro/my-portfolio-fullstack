...
export function Projects() {
  ...
  return (
    <section id="projetos" className="flex items-center justify-center flex-col min-h-screen p-6">
      <div className="max-w-7xl backdrop-blur-sm rounded-2xl p-8 md:p-12 max-sm:place-items-center">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projectsPT_BR.map((project, index) => (
            ...
            >
              ...
              >
                <div className="absolute -inset-2 bg-linear-to-r from-purple-600 to-blue-600 rounded-lg opacity-0 group-hover:opacity-20 transition-opacity blur-lg" />
                <div className="w-full relative bg-gray-950/50 backdrop-blur-sm rounded-lg p-4 border border-gray-800/50 hover:border-purple-500/50 transition-colors">
                  ...
                  <div className="flex flex-wrap gap-2 mb-6">
                    {project.tech.map((tech) => (
                      <span
                        key={tech}
                        className="px-2 py-1 bg-gray-900/50 backdrop-blur-sm text-purple-400 rounded-sm text-sm"
                      >
                        {tech}
                      </span>
                    ))}
