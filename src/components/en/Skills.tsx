          ...
          {skillCategories.map((category, index) => (
            ...
            >
              ...
              >
                ...
                <div className="relative bg-gray-950/50 backdrop-blur-sm rounded-lg p-6 border border-gray-800/50 hover:border-purple-500/50 transition-colors">
                  ...
                  <div className="flex flex-wrap gap-3">
                    {category.skills.map((skill) => (
                      <span
                        key={skill}
                        className="px-3 py-1 bg-gray-900/50 backdrop-blur-sm text-gray-300 rounded-full text-sm hover:bg-purple-500 hover:text-white transition-colors duration-300"
                      >
                        {skill}
                      </span>
                    ))}
